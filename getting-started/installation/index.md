...
Use source install if you are developing in this repository. Use wheel install if you want to consume a pinned release artifact without cloning the repo.
